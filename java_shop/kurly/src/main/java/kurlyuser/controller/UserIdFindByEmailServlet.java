...
@WebServlet("/idfindemail")
public class UserIdFindByEmailServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            UserIdFindDTO result = userDao.idSearchAtEmail(user.getUserName(), user.getUserEmail());
